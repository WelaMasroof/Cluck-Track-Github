...
namespace Poultry_Management_System
{
    public partial class Diff_Form : Form
    {
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            if (!int.TryParse(Expensecategorytextbox.Text, out purchase) || purchase <= 0)
            {
            ...
            if (!int.TryParse(textBox3.Text, out hen) || hen<=0 || 
                !int.TryParse(textBox2.Text, out roaster) || roaster <= 0)
            {
